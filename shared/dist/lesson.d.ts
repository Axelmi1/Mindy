 ...
 */
export type LessonStep = InfoStep | QuizStep | SwipeStep | SwipeSequenceStep | ReorderStep | VisualPickStep | MatchPairsStep | FillBlankStep | CalculatorStep | ScenarioStep | PricePredictionStep | SpeedRoundStep | BudgetAllocatorStep | NewsImpactStep | FlashcardStep | WordScrambleStep | DragSortStep | SpotTheScamStep | ConnectDotsStep | TimelineBuilderStep;
/**
