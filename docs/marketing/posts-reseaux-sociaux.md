...
## Visuel 2 — « Tu scrolles 2h sur la crypto… » (hook, 9:16)

**TikTok / Reels** (le visuel sert de fond ou de première frame)
> Tu scrolles 2h sur la crypto mais t'as toujours rien compris ? 🧠⚡
> 5 min sur Mindy et t'as les bases. Quiz, mini-jeux, défis — zéro cours magistral.
> #crypto #financeperso #apprendresurtiktok #argent #etudiant

**Idée de script vidéo (15 s)**
1. (0-3 s) Écran partagé : doomscroll rouge chaotique → « toi à 1h du mat' »
2. (3-8 s) Capture app : leçon « spot the scam », swipe, +50 XP, confetti
3. (8-12 s) Classement ligue Or, défi envoyé à un pote
4. (12-15 s) CTA : « Scanne, c'est gratuit » + QR Expo Go
...
## Visuel 4 — « 3 ERREURS de débutant en crypto » (carrousel éducatif, 1:1)

**Instagram carrousel — slides suivantes (texte) :**
...
## Visuel 5 — « DÉFIE TES POTES » (social/viralité, 1:1)

**Instagram / TikTok**
> Réviser seul, c'est bien. Écraser ton pote sur un quiz crypto, c'est mieux. ⚔️
> Défis 1v1 sur n'importe quelle leçon, score en direct, revanche illimitée.
> Tag le pote que tu vas détruire. 👇
> #challenge #quiz #crypto #duel
...
## Calendrier suggéré (2 semaines avant soutenance)

| Jour | Réseau | Post |
|---|---|---|
| J-14 | LinkedIn + X | Visuel 1 (positionnement) |
| J-12 | TikTok | Visuel 2 + vidéo hook |
| J-10 | Instagram | Visuel 4 (carrousel) |
| J-7 | Instagram | Visuel 3 (série) |
| J-5 | TikTok/IG | Visuel 5 (défis) + tag entre membres de l'équipe |
| J-2 | Stories | Visuel 6 + QR de test Expo Go |

**Mesure des résultats** (pour la partie « Promotion extérieure » de la soutenance) : vues, likes, partages, clics sur le lien, et surtout **inscriptions bêta** (visibles dans l'admin analytics de l'app — funnel signup).
